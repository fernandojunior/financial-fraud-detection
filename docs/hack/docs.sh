...
sphinx-apidoc -f -e -o docs/source/apidoc/ fraud_detection/
...
sed -i.bak '0,/fraud_detection/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i.bak '0,/project/s//fraud_detection/' docs/source/index.rst
# Delete backup files
